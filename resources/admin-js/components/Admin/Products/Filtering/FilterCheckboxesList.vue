<template>
    <div class="selectedCategories__wrapper product_filter__selectedCategories__wrapper">
        ...
        <div @click.stop class="relative_checkboxes_wrapper" v-if="checkboxesAreVisible">
            <div class="absolute_checkboxes_list show_block">
                ...
                <p v-for="cat of localCategories" :key="cat.id" class="checkbox_input__item product_filter__checkbox_input__item tal">
