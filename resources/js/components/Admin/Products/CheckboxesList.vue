<template>
    ...
    <div class="selectedCategories__wrapper">
        <p @click="closeAllCheckboxesLists()" class="product_form__property_header">
            {{ header }}
        </p>

        <div class="selectedCategories">
            <div @click.self="changeCheckboxesVisibility()" class="selectedCategories__items">
            ...
            <div @click="changeCheckboxesVisibility()" class="selectedCategories__arrow">
                &#709;
            </div>
        </div>


        <div class="relative_checkboxes_wrapper" v-if="checkboxesAreVisible">
