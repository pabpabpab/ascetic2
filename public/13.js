        ...
        _c("div", { staticClass: "pdt20 pdb20" }, [
          _c("p", { staticClass: "checkbox_input__item tal" }, [
            _c("input", {
              ...
              domProps: {
                checked: Array.isArray(_vm.localUser.send_confirm_registration)
                  ? _vm._i(_vm.localUser.send_confirm_registration, "true") > -1
              ...
              on: {
                ...
                change: function($event) {
                  ...
                  if (Array.isArray($$a)) {
                    ...
                    _vm.$set(_vm.localUser, "send_confirm_registration", $$c)
                  }
                }
              }
            }),
