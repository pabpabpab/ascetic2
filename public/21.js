  ...
  function() {
    ...
    return _c("div", { staticClass: "show_block" }, [
      _c("div", { staticClass: "content_block helpPage" }, [
        ...
        _c("br"),
        _vm._v(
          "\n        - У каждой категории и товара, а также у каждого отдельного фото можно добавить\n        title и description их страницы через пункт контекстного меню с названием SEO\n        (title и description страницы категории с товарами в ней, страницы с каждым\n        отдельным товаром, страницы с каждым отдельным фото).\n        (Создавать вышеупомянутые отдельные title и description страниц необязательно,\n        они будут назначены сайтом автоматически, применяя принципы SEO).\n        "
        ),
        _c("br"),
        _c("br"),
        _c("br"),
