...
Вход в Админ-панель через иконку человечка в правом верхнем углу http://AsceticShop.ru: логин admin@adm.adm, пароль 123456 . POST-запросы в панели отключены, поэтому там можно делать всё.
