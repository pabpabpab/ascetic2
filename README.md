Алексей Постников, 47 лет, ищу работу удаленно, junior-программист JavaScript, Vue, Laravel, PHP. 
...
Вход в панель администратора через иконку человечка в правом верхнем углу https://AsceticShop.ru: логин admin@adm.adm, пароль 123456 (в мобильной версии вход через иконку три полоски правый верхний угол, в открывшемся меню иконка человечек внизу). POST-запросы в панели отключены, поэтому там можно делать всё.
